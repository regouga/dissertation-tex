...
Radialize     & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{FFCCC9}No & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{9AFF99}Yes \\ \hline
MyMyRadio     & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{FFCCC9}No  & \cellcolor[HTML]{FFCCC9}No & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{9AFF99}Yes & \cellcolor[HTML]{FFCCC9}No  \\ \hline
\end{tabular}%
}
