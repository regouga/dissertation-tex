...
\fancychapter{Concept Validation}
%\cleardoublepage
...
\begin{figure}[htbp]
	\centering
	\subfigure["Carolina Santos" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/persona1.png}} \qquad
	\subfigure["Manuel Fernandes" persona]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/persona2.png}}
		\subfigure["Rita Silva" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/persona3.png}} \qquad
	\subfigure["Tomás Ventura" persona]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/persona4.png}}
...
\begin{figure}[htbp]
	\centering
	\subfigure["Carolina Santos" storyboard on paper]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard1w.pdf}} \qquad
	\subfigure["Manuel Fernandes" storyboard on paper]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard2w.pdf}}
		\subfigure["Rita Silva" storyboard on paper]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard3w.pdf}} \qquad
	\subfigure["Tomás Ventura" storyboard on paper]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard4w.pdf}}
	\caption{Created paper storyboards and scenarios for each persona}
	\label{fig:paperstoryboard}
\end{figure}


\begin{figure}[htbp]
	\centering
	\subfigure["Carolina Santos" digital storyboard]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard1d.pdf}} \qquad
	\subfigure["Manuel Fernandes" digital storyboard]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard2d.pdf}}
		\subfigure["Rita Silva" digital storyboard]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard3d.pdf}} \qquad
	\subfigure["Tomás Ventura" digital storyboard]{\label{fig:uiplayout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard4d.pdf}}
...
\hline
\multirow{2}{*}{\textbf{Age}} & \multicolumn{2}{c|}{\textbf{User Research}} & \multicolumn{2}{c|}{\textbf{Speed Dating}}          \\ \cline{2-5} 
...
Based on the presented table, we developed a medium-fidelity prototype aimed at showcasing a preliminary concept of the Sterio system to the common user, shown in Figures ~\ref{fig:mfp11}, ~\ref{fig:mfp2}, and ~\ref{fig:mfp3}. The prototype focused on merging a users' music streaming service library and audio dynamically generated from news, social networks, or even personal sources, with non-speech audio sound effects and background music. In this first stage, we focused on the 'Create' and 'Listen' design dimensions, which resulted in the creation of a set of dummy and non-technical screens to avoid possible distractions concerning superficial design considerations.

\begin{figure}[htbp]
	\centering
	\subfigure[Home screen]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/0.png}}} \qquad
	\subfigure["My Stations" screen]{\label{fig:ui_playout}
		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/1.png}}} \qquad
		\subfigure["Create station" screen]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/2.png}}} \qquad
...
\begin{figure}[htbp]
	\centering
	\subfigure["Add blocks" screen]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/3.png}}} \qquad
	\subfigure["Add blocks" screen with added blocks]{\label{fig:ui_playout}
		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/4.png}}} \qquad
		\subfigure[Main screen of the "Morning Station" station]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/6.png}}} \qquad
...
The middle-fidelity prototype was created using three main tools: Adobe XD~\footnote{For more information, visit the \href{https://www.adobe.com/products/xd.html}{Adobe XD website}.}, Audacity~\footnote{For more information, visit the \href{https://www.audacityteam.org/}{Audacity website}.}, and macOS Text To Speech voices. 
...
\begin{figure}[htbp]
	\centering
	\subfigure[Spotify block configuration screen]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/7.png}}} \qquad
	\subfigure[News block configuration screen]{\label{fig:ui_playout}
		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/8.png}}} \qquad
		\subfigure[Station's schedule screen]{\label{fig:ui_loading} 		\frame{\includegraphics[width=0.29\textwidth]{./Images/mfp/9.png}}} \qquad
	\caption{Screenshots of the medium fidelity prototype (3)}
	\label{fig:mfp3}
\end{figure}
