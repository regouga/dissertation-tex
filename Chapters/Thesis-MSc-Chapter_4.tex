...
Based on the presented table, we developed a medium fidelity prototype aimed at showcasing a preliminary concept of the Sterio platform to the common user. The prototype focused on merging a users' music streaming service library and audio dynamically generated from news, social networks, or even personal sources, with non-speech audio sound effects and background music. In this first stage, we focused on the 'create' and 'listen' design dimensions, which resulted in the creation of a set of dummy and non-technical screens to avoid possible distractions concerning superficial design considerations.

\begin{figure}[htbp]
	\centering
	\subfigure[Home screen]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/0.png}} \qquad
	\subfigure["My Stations" screen]{\label{fig:ui_playout}
		\includegraphics[width=0.29\textwidth]{./Images/mfp/1.png}} \qquad
		\subfigure["Create station" screen]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/2.png}} \qquad
...
\begin{figure}[htbp]
	\centering
	\subfigure["Add blocks" screen]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/3.png}} \qquad
	\subfigure["Add blocks" screen with added blocks]{\label{fig:ui_playout}
		\includegraphics[width=0.29\textwidth]{./Images/mfp/4.png}} \qquad
		\subfigure[Main screen of the "Morning Station" station]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/6.png}} \qquad
...
\begin{figure}[htbp]
	\centering
	\subfigure[Spotify block configuration screen]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/7.png}} \qquad
	\subfigure[News block configuration screen]{\label{fig:ui_playout}
		\includegraphics[width=0.29\textwidth]{./Images/mfp/8.png}} \qquad
		\subfigure[Station's schedule screen]{\label{fig:ui_loading} 		\includegraphics[width=0.29\textwidth]{./Images/mfp/9.png}} \qquad
