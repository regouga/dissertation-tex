...
\begin{figure}[htbp]
	...
	\subfigure["Manuel Fernandes" persona]{\label{fig:ui_playout}
	...
	\subfigure["Tomás Ventura" persona]{\label{fig:ui_playout}
...
\begin{figure}[htbp]
	\centering
	\subfigure["Carolina Santos" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard1w.pdf}} \qquad
	\subfigure["Manuel Fernandes" persona]{\label{fig:ui_playout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard2w.pdf}}
		\subfigure["Rita Silva" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard3w.pdf}} \qquad
	\subfigure["Tomás Ventura" persona]{\label{fig:ui_playout}
...
\begin{figure}[htbp]
	\centering
	\subfigure["Carolina Santos" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard1d.pdf}} \qquad
	\subfigure["Manuel Fernandes" persona]{\label{fig:ui_playout}
		\includegraphics[width=0.45\textwidth]{./Images/storyboard2d.pdf}}
		\subfigure["Rita Silva" persona]{\label{fig:ui_loading} 		\includegraphics[width=0.45\textwidth]{./Images/storyboard3d.pdf}} \qquad
	\subfigure["Tomás Ventura" persona]{\label{fig:ui_playout}
